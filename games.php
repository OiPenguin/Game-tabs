        ...
        <?php /* ?>
        <br/>                
        <h1><?php  _e('Latest matches','MyLanguage'); ?></h1>        
        <br/> 
        <?php */ ?>           
        <br/> 
        <?php       
        if(TEAM_GLOBAL!=''){
            ...
            (wp_strommen_matches.home_team_id  IN (".TEAM_GLOBAL.") OR wp_strommen_matches.away_team_id  IN (".TEAM_GLOBAL.") ) ORDER BY wp_strommen_matches.match_date DESC ";
        ...
        <table border="1" class="table_row" >
               ...
               // DebugBreak();
                 ?> 
                     ...
                     {?>
                     <tr align="left">
                      <td colspan="7"  width="20%" align="center"><?php _e('No Records','MyLanguage');?></td>
                      </tr>
                      <?php } ?>
                </table>     
